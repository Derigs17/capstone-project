                ...
                <Row className="justify-content-center">
                    <Col sm={4} style={squareStyle}>
                        <Link to="/magang-umum" style={squareStyle}>
                            <h5 className="text-center bold-text text-black">Umum</h5>
                        </Link>
                    </Col>
                    <Col sm={4} style={squareStyle}>
                        <Link to="/magang-kompetisi" style={squareStyle}>
                            <h5 className="text-center bold-text text-black">Kompetisi</h5>
                        </Link>
                    </Col>
                </Row>
            </Container>
                ...
                <Row className="justify-content-center">
                    <Col sm={4} style={squareStyle}>
                        <Link to="/panduan-magang" style={squareStyle}>
                            <h5 className="text-center bold-text text-black">Panduan Magang</h5>
                        </Link>
                    </Col>
                    <Col sm={4} style={squareStyle}>
                        <Link to="/alur-magang" style={squareStyle}>
                            <h5 className="text-center bold-text text-black">Alur Magang</h5>
                        </Link>
                    </Col>
                </Row>
            </Container>
